...
import { zoneToRect, fitFontSize, fitTextToRect, isNumberZone, fitInkToRect, inkAlignedCenter, FABRIC_BOX_RATIO, NUMBER_TOP_INSET_PX, clipRect} from '../core/ZoneManager.js?v=20260913g';
import { cropToImageRect } from '../core/ZoneOverrides.js?v=20260913g';
import { яркостьТкани } from '../core/TextColor.js?v=20260913g';
import { создатьСчётчикЗагрузок } from '../core/LatestLoad.js?v=20260913g';
import { capWidthByHeight, fitCanvasInCard, FRAME_ASPECT } from '../core/CanvasFit.js?v=20260913g';
