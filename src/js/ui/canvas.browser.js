...
import { zoneToRect, fitFontSize, fitTextToRect, isNumberZone, fitInkToRect, inkAlignedCenter, FABRIC_BOX_RATIO, NUMBER_TOP_INSET_PX, clipRect} from '../core/ZoneManager.js?v=20260913a';
import { cropToImageRect } from '../core/ZoneOverrides.js?v=20260913a';
import { яркостьТкани } from '../core/TextColor.js?v=20260913a';
import { создатьСчётчикЗагрузок } from '../core/LatestLoad.js?v=20260913a';
import { capWidthByHeight, fitCanvasInCard, FRAME_ASPECT } from '../core/CanvasFit.js?v=20260913a';
