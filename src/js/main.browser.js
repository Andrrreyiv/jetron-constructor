...
import { validateConfig } from './core/ConfigLoader.js?v=20260925b';
import { validateOverrides, validateCrops } from './core/ZoneOverrides.js?v=20260925b';
import { applyAdminOverrides } from './core/AdminOverrides.js?v=20260925b';
import { применитьВид } from './core/Appearance.js?v=20260925b';
...
import { UniformApp } from './ui/app.browser.js?v=20260925b';
import { initZoneEditor } from './ui/zone-editor.browser.js?v=20260925b';
