...
import { validateConfig } from './core/ConfigLoader.js?v=20260922a';
import { validateOverrides, validateCrops } from './core/ZoneOverrides.js?v=20260922a';
import { applyAdminOverrides } from './core/AdminOverrides.js?v=20260922a';
import { применитьВид } from './core/Appearance.js?v=20260922a';
...
import { UniformApp } from './ui/app.browser.js?v=20260922a';
import { initZoneEditor } from './ui/zone-editor.browser.js?v=20260922a';
