...
import { validateConfig } from './core/ConfigLoader.js?v=20260924a';
import { validateOverrides, validateCrops } from './core/ZoneOverrides.js?v=20260924a';
import { applyAdminOverrides } from './core/AdminOverrides.js?v=20260924a';
import { применитьВид } from './core/Appearance.js?v=20260924a';
...
import { UniformApp } from './ui/app.browser.js?v=20260924a';
import { initZoneEditor } from './ui/zone-editor.browser.js?v=20260924a';
